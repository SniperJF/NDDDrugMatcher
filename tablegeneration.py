...
Table1Title  = ["Table 1.  Disease-modifying drugs in independent trials involving more than 1 neurodegenerative disorder."]
Table2Title  = ["Table 2.  Disease-modifying drugs in single trials that included more than 1 neurodegenerative disorder."]
...
Table5Title  = ["Table 5.  devices in independent trials involving more than 1 neurodegenerative disorder."]
Table6Title  = ["Table 6.  devices in single trials that included more than 1 neurodegenerative disorder."]
Table7Title  = ["Table 7.  non-drugs in independent trials involving more than 1 neurodegenerative disorder."]
Table8Title  = ["Table 8.  non-drugs in single trials that included more than 1 neurodegenerative disorder."]
Table9Title  = ["Table 9.  All Intervention Matches in independent trials involving more than 1 neurodegenerative disorder."]
Table10Title = ["Table 10. All Intervention Matches in single trials that included more than 1 neurodegenerative disorder."]
...
def generateCTOTable10(trialNCTIDlist, CTO): #generates list of objects
    tableAsCTO = []
...
def generateCTOTable9(iTML, CTO): #generates list of objects
    tableAsCTO = []
    for entry in iTML:
